            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" enctype="multipart/form-data" action="<?= base_url('admins/settings/edit/') . $setting['id'] ?>">
                        ...
                        <!-- <div class="row mb-3">
                            <label for="inputNumber" class="col-sm-3 col-form-label">Sampul <sup class="text-secondary">Min Height 1100px</sup></label>
                            <div class="col-sm-9">
