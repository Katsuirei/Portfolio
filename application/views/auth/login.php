...
<head>
    ...
    <!-- Favicons -->
    <!-- <link href="?= base_url() ?>vendor/admin/assets/img/icon.png" rel="icon"> -->
    <!-- <link href="?= base_url('vendor/admin/') ?>assets/img/icon.png" rel="apple-touch-icon"> -->
    ...
    <style>
        body {
            /* background: url("?= base_url('vendor/images/bg_lg.jpg') ?>"); */
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="<?= base_url() ?>admin/proses_login" method="post">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="invalid-feedback">Masukkan Password.</div> <br>
                                        </div>
                                        <div class="col-12">
